...
import 'package:flutter_html_render/image_render.dart';
import 'package:flutter_html_render/src/html_elements.dart';
import 'package:flutter_html_render/style.dart';
import 'package:html/dom.dart' as dom;
import 'package:webview_flutter/webview_flutter.dart';

//export render context api
export 'package:flutter_html_render/html_parser.dart';
export 'package:flutter_html_render/image_render.dart';
//export src for advanced custom render uses (e.g. casting context.tree)
export 'package:flutter_html_render/src/anchor.dart';
export 'package:flutter_html_render/src/interactable_element.dart';
export 'package:flutter_html_render/src/layout_element.dart';
export 'package:flutter_html_render/src/replaced_element.dart';
export 'package:flutter_html_render/src/styled_element.dart';
//export style api
export 'package:flutter_html_render/style.dart';

// class FlutterHtmlRender {
//   static const MethodChannel _channel =
//       const MethodChannel('flutter_html_render');
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: HtmlParser(
        ...
        tagsList: tagsList.isEmpty ? FlutterHtml.tags : tagsList,
